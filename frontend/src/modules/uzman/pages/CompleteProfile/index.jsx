...
import {
    User, GraduationCap, Award, FileText,
    ChevronRight, ChevronLeft, Upload, X,
    HeartPulse, BadgeDollarSign
} from 'lucide-react';
...
export default function CompleteProfile() {
    ...
    const toggleExpertise = (category, value) => {
        ...
        setFormData(prev => ({
            ...prev,
            uzmanlikAlanlari: { ...prev.uzmanlikAlanlari, [category]: updated }
        }));
    };

    const isSelected = (category, value) =>
        (formData.uzmanlikAlanlari[category] || []).includes(value);
    ...
    const handlePhotoChange = (e) => {
        ...
        setFormData(prev => ({ ...prev, profilFotograf: file }));
    ...
    const addCertificate = () => {
        ...
        setFormData(prev => ({
            ...prev,
            sertifikalar: [...prev.sertifikalar, { adi: '', dosya: null }]
        }));
    };
    ...
    const updateCertificate = (index, field, value) => {
        setFormData(prev => {
            const updated = [...prev.sertifikalar];
            updated[index][field] = value;
            return { ...prev, sertifikalar: updated };
        });
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (formData.profilFotograf) submitData.append('profilFotograf', formData.profilFotograf);
            ...
            if (formData.sertifikalar.length > 0) {
                submitData.append('sertifikalar', JSON.stringify(
                    formData.sertifikalar.map(cert => ({ adi: cert.adi }))
                ));
            ...
            setSuccess('Profil başarıyla tamamlandı!');
            setTimeout(() => navigate('/uzman/dashboard'), 1500);
        } catch (err) {
                ...
                return (
                    <motion.div initial="hidden" animate="visible" variants={fadeUp} className="space-y-6">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-500 text-sm mt-2">Temel bilgilerinizi girin</p>
                        </div>
                        ...
                        <div className="pt-2">
                            <label className="block text-sm font-bold text-[#0a2e1a] mb-3">Profil Fotoğrafı <span className="text-gray-400 font-normal">(Opsiyonel)</span></label>
                ...
                return (
                    <motion.div initial="hidden" animate="visible" variants={fadeUp} className="space-y-6">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-500 text-sm mt-2">Akademik geçmişinizi girin</p>
                        </div>
                        ...
                        <Input
                            ...
                            onChange={(e) => setFormData(prev => ({ ...prev, mezuniyetOkul: e.target.value }))}
                        ...
                        <Input
                            ...
                            onChange={(e) => setFormData(prev => ({ ...prev, mezuniyetYili: e.target.value }))}
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                onChange={(e) => setFormData(prev => ({ ...prev, biyografi: e.target.value }))}
                                maxLength={500}
                                rows={6}
                ...
                return (
                    <motion.div initial="hidden" animate="visible" variants={fadeUp} className="space-y-6">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-500 text-sm mt-2">Mesleki belgelerinizi sisteme ekleyin <span className="text-gray-400">(Opsiyonel)</span></p>
                        </div>
                        ...
                        {formData.sertifikalar.map((cert, index) => (
                            <div key={index} className="bg-gray-50 p-6 rounded-3xl relative border border-gray-100 group hover:border-[#4ade80]/40 transition-colors">
                                ...
                                <div className="space-y-4 pr-10">
                                    ...
                                    />
                                    <div>
                                        <label className="block text-sm font-bold text-[#0a2e1a] mb-2">Belge Yükle</label>
                                        <input
                                            type="file"
                ...
                return (
                    <motion.div initial="hidden" animate="visible" variants={fadeUp} className="space-y-6">
                        ...
                        <div className="bg-[#f0fdf4] rounded-3xl p-6 border border-[#bbf7d0] space-y-5">
                            <div>
                                <label className="block text-sm font-black text-[#0a2e1a] mb-1">💻 Online Seans Ücreti (₺)</label>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setFormData(prev => ({ ...prev, onlineSeansucreti: e.target.value }))}
                                        placeholder="Örn: 500"
                            ...
                            <div>
                                <label className="block text-sm font-black text-[#0a2e1a] mb-1">🏠 Evde Tedavi Seans Ücreti (₺)</label>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setFormData(prev => ({ ...prev, evdeSeansucreti: e.target.value }))}
                                        placeholder="Örn: 800"
                                        className="w-full pl-9 pr-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#4ade80] focus:border-[#4ade80] bg-white text-sm font-bold text-[#0a2e1a] transition-all"
                                    />
                                </div>
                        ...
                        <div className="border-t border-[#bbf7d0] pt-5 space-y-3">
                            <div>
                                <label className="block text-sm font-black text-[#0a2e1a] mb-1">🏦 IBAN Numaranız</label>
                                ...
                                <input
                                    ...
                                    onChange={(e) => setFormData(prev => ({ ...prev, ibanNo: e.target.value.toUpperCase() }))}
                            ...
                            <div>
                                <label className="block text-sm font-black text-[#0a2e1a] mb-1">Hesap Sahibi Adı Soyadı</label>
                                <input
                                    type="text"
                                    value={formData.ibanAdSoyad}
                                    onChange={(e) => setFormData(prev => ({ ...prev, ibanAdSoyad: e.target.value }))}
            ...
            <div className="max-w-3xl mx-auto pb-28 lg:pb-8">
                ...
                >
                    <div className="mb-8 sm:mb-10">
                        ...
                        <p className="text-gray-500 text-sm mt-2">Hastalarla eşleşebilmek için bilgilerini eksiksiz doldur.</p>
                    </div>
                            ...
                            {currentStep < totalSteps ? (
                                ...
                                >
                                    {loading ? (
                                        ...
                                        <>
                                            <HeartPulse size={18} /> Profili Tamamla
                                        </>
                                    )}
                                </button>
                            )}
