...
export const ILCELER = {
  ...
  "Çankırı": ["Atkaracalar", "Bayramören", "Çerkeş", "Eldivan", "Ilgaz", "Khanbeyli", "Kurşunlu", "Merkez", "Orta", "Şabanözü", "Yapraklı"],
  ...
  "Erzurum": ["Aşkale", "Aziziye", "Çat", "Hınıs", "Horasan", "İspir", "Karaçoban", "Karayazı", "Köprüköy", "Merkez", "Narman", "Oltu", "Olur", "Palandöken", "Pasinler", "Pazaryolu", "Şenkaya", "Tekman", "Tortum", "Uzundere"],
  ...
  "Hatay": ["Altınözü", "Antakya", "Arsuz", "Belen", "Dörtyol", "Erzin", "Hassa", "İskenderun", "Kırıkhan", "Kumlu", "Nurdağı", "Payas", "Reyhanlı", "Samandağ", "Yayladağı"],
